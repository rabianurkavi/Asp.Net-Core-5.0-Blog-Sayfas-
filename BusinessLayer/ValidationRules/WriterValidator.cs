...
namespace BusinessLayer.ValidationRules
{
    public class WriterValidator:AbstractValidator<Writer>
    {
        public WriterValidator()
        {
            ...
            RuleFor(x => x.WriterPassword).MinimumLength(7).WithMessage("Şifre en az 7 kaarakter olmalı");
            RuleFor(x => x.WriterPassword).MaximumLength(12).WithMessage("Şifre en fazla 12 karakter olmalı");
